...
public class NotificationClient {
    ...
    private static final ParameterizedTypeReference<PageResponse<BotNotificationResponseDto>> NOTIFICATION_PAGE_TYPE =
            new ParameterizedTypeReference<>() {};

    private final RestClient notificationRestClient;

    public List<BotNotificationResponseDto> getUnreadNotifications(String jwt, int pageNumber, int pageSize) {
        PageResponse<BotNotificationResponseDto> response = notificationRestClient.get()
